...
void read_from_text_file_and_create_board(int bboard_size_X, int board_size_Y,int* board[], char *filenanme, char names[10][200]);
void write_to_text_file(int board_size_X,int board_size_Y, int* board[],char *filenanme, char name[10][200]);
